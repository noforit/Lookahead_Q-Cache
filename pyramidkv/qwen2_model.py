...
def qwen2_flash_attn2_forward_PyramidKV(
    ...
    **kwargs,
    ...
    rotary_seq_len = position_ids[:, -1].max().item() + 1
...
def _prepare_4d_causal_attention_mask_with_cache_position(
    ...
    return causal_mask
def prepare_inputs_for_generation_qwen2_new(
        self,
        input_ids,
...
def Qwen2FlashAttention2_forward_LAQ(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
from pyramidkv.llama_model import  select_KV_lookahead_stage, select_KV_decoding_stage, get_softmax_max_tokenid
from pyramidkv.pyramidkv_utils import DynamicCache_LAQ
from transformers.cache_utils import DynamicCache



def Qwen2ForCausalLM_forward_LAQ(
    self,
    input_ids: torch.LongTensor = None,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
