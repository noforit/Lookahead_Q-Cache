...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        if(self.model_provider in ["LLaMA3", "Mistral", "qwen2"]):
            ...
            if self.method in ["pyramidkv", "snapkv","streamingllm","h2o","cam",'speckv']:
                ...
                elif self.model_provider == 'qwen2':
                    replace_qwen25(self.method.lower())
                ...
                if self.method.lower() == "pyramidkv":
                    ...
                    self.model_to_test.config.all_query = args.all_query
                    # window_sizes =0
                    self.model_to_test.config.lookahead_method = lookahead_method
                    self.model_to_test.config.window_sizes = window_sizes
                    self.model_to_test.config.stage2_window_sizes = stage2_window_sizes
                    self.model_to_test.config.max_capacity_prompts = max_capacity_prompts
                    self.model_to_test.config.lookahead_max_capacity_prompts = max_capacity_prompts
                    self.model_to_test.config.fout_q_local = None
                    self.model_to_test.config.fout_q_ahead = None
    ...
    def generate_prompt(self, context):
        ...
        if(self.model_provider not in ["OpenAI", "Anthropic"]):
            ...
            # if self.model_provider in ['qwen2']:
            #     messages = [
            #         # {"role": "system", "content": "You are a pirate chatbot who always responds in pirate speak!"},
            #         {"role": "user", "content": test_format},
            #     ]
    ...
    def encode_text_to_tokens(self, text):
        if self.model_provider in ["Mistral", "LLaMA3", "qwen2"]:
    ...
    def insert_needle(self, context, depth_percent, context_length):
        ...
        if depth_percent == 100:
            ...
            # elif(self.model_provider == 'qwen2'): period_tokens = []
